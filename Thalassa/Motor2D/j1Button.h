...
public:
	...
	j1Button(UIELEMENT_TYPES type, int x, int y, SDL_Rect idle, SDL_Rect hovered, SDL_Rect clicked, SDL_Texture* text = nullptr, ButtonFunction function = ButtonFunction::NO_FUNCTION, j1UIElement* parent = nullptr);
